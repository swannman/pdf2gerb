...
# x3[-6] y3[-5] x4[-4] y4[-3]
    ...
    if (($drawPath[$x4] != $drawPath[$x1]) && ($drawPath[$y4] != $drawPath[$y1])) { return FALSE; }
    if (($drawPath[-18] != $drawPath[-16]) && ($drawPath[-17] != $drawPath[-15])) { return FALSE; }
    if (($drawPath[-12] != $drawPath[-10]) && ($drawPath[-11] != $drawPath[-9])) { return FALSE; }
    if (($drawPath[-6] != $drawPath[-4]) && ($drawPath[-5] != $drawPath[-3])) { return FALSE; }
...
sub reduceCircle
{
    ...
    if (($drawPath[-40] != $drawPath[-4]) || ($drawPath[-39] != $drawPath[-3]) || #x1,y1
        ($drawPath[-30] != $drawPath[-34]) || ($drawPath[-29] != $drawPath[-33]) || #x2,y2
        ($drawPath[-20] != $drawPath[-24]) || ($drawPath[-19] != $drawPath[-23]) || #x3,y3
        ($drawPath[-10] != $drawPath[-14]) || ($drawPath[-9] != $drawPath[-13])) #x4,y4
        { return FALSE; }
    ...
    if (inches(abs($maxX - $minX - $maxY + $minY)) > .001) { mywarn("ellipse?"); return FALSE; } #ellipse or other shape; not implemented
